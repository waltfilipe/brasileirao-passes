...
export function getMeta(positionFamily = "all") {
  return fetchApi<{
...
export function getPlayerProfile(id: string, positionFamily = "all") {
  const qs = new URLSearchParams({ position_family: positionFamily });
  return fetchApi<PlayerProfile>(`/api/players/${id}?${qs}`);
}

export function getCompare(playerA: string, playerB: string, positionFamily = "all") {
  const qs = new URLSearchParams({
    player_a: playerA,
    player_b: playerB,
...
export function getScatter(x: string, y: string, highlight?: string, positionFamily = "all") {
...
export function getAggregatedMaps(positionFamily = "all") {
  const qs = new URLSearchParams({ position_family: positionFamily });
  return fetchApi<{
    player_count: number;
    total_passes: number;
